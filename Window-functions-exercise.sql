...
SELECT
	...
	, cc.DateRecorded
	, cc.DailyCases
	, cc.RollingCases AS CumulativeCases
FROM
	CovidCase cc
...
SELECT
	...
	, cc.Country
	, cc.DailyCases
	--, AVG(cc.DailyCases) OVER (PARTITION BY cc.Country ORDER BY cc.DateRecorded ROWS BETWEEN 6 PRECEDING AND CURRENT ROW) / 7.0 SevenDayMovingAverageCases
